...
const CardList: React.FC = ()  => {
  ...
  useEffect(() => {
    fetchWallpapers();
  }, [state.page, state.queryString, state.selectedCategory, state.appliedFilters]);
  ...
  return (
      <View style={styles.container}>
            <MasonryFlashList
              ...
              ListFooterComponent={state.loading ? <ActivityIndicator color={theme.colors.pink} size={30}/> : null}
            />
    </View>
  );
}
